...
import { View, StyleSheet } from "react-native";
import ImageViewer from "@/components/ImageViewer";// <- são componentes personalizados localizados na pasta components do projeto.
import Button from "@/components/Button";// <- são componentes personalizados localizados na pasta components do projeto.
...
import IconButton from "@/components/IconButton";// <- são componentes personalizados localizados na pasta components do projeto.
import CicleButton from "@/components/CicleButton";// <- são componentes personalizados localizados na pasta components do projeto.
import EmojiPicker from "@/components/EmojiPicker";// <- são componentes personalizados localizados na pasta components do projeto.
